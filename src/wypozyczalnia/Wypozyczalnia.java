...
public class Wypozyczalnia {
    ...
    public List<ProfilKlienta> klienci;
    ...
    public String dodajKlienta(String daneklienta[]) throws IllegalFormatCodePointException {
    ...
    public String dodajFilm(String[] daneFilmu) throws IllegalFormatCodePointException {
